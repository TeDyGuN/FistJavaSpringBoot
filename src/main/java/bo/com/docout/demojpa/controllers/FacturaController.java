...
import bo.com.docout.demojpa.models.entity.ItemFactura;
import bo.com.docout.demojpa.models.entity.Producto;
...
public class FacturaController {
    ...
    public String crear(@PathVariable(value = "clienteId") Long clienteId,
        ...
        if (cliente == null) {
            flash.addFlashAttribute("error", "El Clienteno existe en la Base de Datos");
            return "redirect:/listar";
        }
    ...
    public @ResponseBody
    List<Producto> cargarProdcutos(@PathVariable String term) {
